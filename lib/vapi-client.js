...
You're speaking with ${storyteller.name}, who is the user's ${storyteller.relationship}.
...
Start by introducing yourself warmly and explaining you're calling on behalf of their ${storyteller.relationship === 'grandmother' || storyteller.relationship === 'mother' ? 'grandchild/child' : 'family member'}.`;
  ...
  async createAssistant(storyRequest) {
    const assistant = {
      ...
      firstMessage: `Hello! Is this ${storyRequest.storyteller_name}? I'm calling on behalf of your family member who wanted to record some of your stories. They thought it would be wonderful to preserve your memories. Do you have a few minutes to chat?`,
      systemPrompt: this.buildAssistantPrompt(storyRequest),
