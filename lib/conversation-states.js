...
const transitions = {
  ...
  [states.COLLECTING_NAME]: {
    ...
    prompt: "Great! Now I need their phone number. What's the best number to reach them?"
  },
  ...
  [states.COLLECTING_AVOID_TOPICS]: {
    ...
    prompt: "Great questions! Are there any sensitive topics to avoid? (Reply 'none' if not)"
  },
  ...
  [states.COLLECTING_AI_STYLE]: {
    ...
    prompt: "How should the AI interviewer behave?\n1) Warm and friendly\n2) Professional and respectful\n3) Curious and engaging\n\nChoose 1, 2, or 3:"
  },
  ...
  [states.COLLECTING_SCHEDULE]: {
    ...
    error: "Please choose 1-4 or enter a time (e.g., 3:30pm)",
